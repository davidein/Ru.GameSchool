...
namespace Ru.GameSchool.Utilities
{
    ...
    public class PasswordUtilities
    {
        ...
        /// <param name="hashAlgorithm">The algorithm to be used, if null MD5 will be used.</param>
        ...
        public static string ComputeHash(string plainText, string hashAlgorithm = null, byte[] saltBytes = null)
        {
        ...
        public static bool VerifyHash(string plainText, string hashValue, string hashAlgorithm = null)
        {
